...
You can perform the whole procefure of cell-type enrichment analysis and visulaizatin of outputs using CellTypeEnrichment function (you can find the code in `RUN_ME.R` file) (Figure 9):
