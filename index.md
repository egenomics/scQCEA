...
Download and unzip the `OGC_Interactive_QC_Report_ P180121.zip` file available at [https://github.com/isarnassiri/scQCEA/](https://github.com/isarnassiri/scQCEA/blob/Example-of-Application/). You can open `CLICK_ME.html` file without using rStudio/R.
