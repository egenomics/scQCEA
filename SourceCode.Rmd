...
list.of.packages <- c("dplyr", "kableExtra", "DT", "downloadthis", "ggplot2", "data.table",  "stringr", "SciencesPo", "R.utils", "readr", "rmarkdown", "devtools", "DiagrammeR", "Rtools")
...
state_plots =  list.files('Inputs/10X-gex', pattern = '_Knee_Plot.png', recursive = T)

state_plots = paste0('Inputs/10X-gex/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("_Knee_Plot.png" = "", "Inputs/10X-gex/" = "")))
...
state_plots =  list.files('Inputs/10X-gex-grouped', pattern = '_Knee_Plot.png', recursive = T)

state_plots = paste0('Inputs/10X-gex-grouped/', state_plots)

names(state_plots) <- gsub('\\/.*','',str_replace_all(state_plots, c("_Knee_Plot.png" = "", "Inputs/10X-gex-grouped/" = "")))
